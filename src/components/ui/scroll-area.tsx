...
function ScrollArea({
  ...
  return (
    <ScrollAreaPrimitive.Root
      ...
      {...props}
    >
      {/* [&>div]:!block —— Radix 会给 Viewport 里再套一层 `display: table; min-width: 100%` 的
          div，表格宽度按内容撑开，于是内部 flex 子元素的 truncate 失效、整行被撑得比容器宽，
          最右侧的元素（比如会话项的删除按钮）就被横向裁掉了。上游 shadcn 也是这么修的。 */}
