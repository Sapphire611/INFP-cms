/**
 * Chat message - displays a single message with optional tool call indicators
 */
...
import { Bot, User, Wrench, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {!isCalling && !isError && tc.args && Object.keys(tc.args).length > 0 && (
  ...
  return (
    <div className={`flex gap-2 ${isUser ? "flex-row-reverse" : ""}`}>
      ...
      <div className="flex flex-col max-w-[80%] gap-1.5">
        {/* Tool call indicators (assistant messages only) */}
        {hasToolCalls && (
        ...
        {/* If assistant has no content yet but is streaming (tool calls only so far) */}
